...
def dynamics(d,imbalance,ton,toff,dx,full=False):
    ...
    while i < totaltime:
        ...
        if full==True:
            ...
            U[0,1] = U[0,0]+dt*(-U[0,0]+gain_pl_sqrt(kb+S1 - beta*U[1,0] -gamma*A[0,0] + Z[0,0]*(1+mu*U[1,0])))/tau_u
            U[1,1] = U[1,0]+dt*(-U[1,0]+gain_pl_sqrt(kb+S2 - beta*U[0,0] -gamma*A[1,0] + Z[1,0]*(1+mu*U[0,0])))/tau_u
            U[0,0] = U[0,1]
            U[1,0] = U[1,1]
            ...
            U[0,1] = gain_pl_sqrt(kb+S1 - beta*U[1,0] -gamma*A[0,0] + Z[0,0]*(1+mu*U[1,0]))/tau_u
            U[1,1] = gain_pl_sqrt(kb+S2 - beta*U[0,0] -gamma*A[1,0] + Z[1,0]*(1+mu*U[0,0]))/tau_u
            U[0,0]= U[0,1]
            U[1,0]= U[1,1]
